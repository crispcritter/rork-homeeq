...
const createApplianceStyles = (c: any) => StyleSheet.create({
  ...
  heroPrimaryText: { fontSize: 11, fontWeight: '600', color: c.white },
  ...
  heroInitial: { fontSize: 56, fontWeight: '700', color: c.primary, opacity: 0.35 },
  ...
  title: { fontSize: 24, fontWeight: '700', color: c.text, marginBottom: 4, letterSpacing: -0.3 },
  ...
  warrantyStatus: { fontSize: 16, fontWeight: '600' },
  warrantyExpiry: { fontSize: 14, color: c.text, fontWeight: '500', marginBottom: 4 },
  ...
  countText: { fontSize: 12, fontWeight: '600', color: c.textSecondary },
  ...
  statusChipText: { fontSize: 10, fontWeight: '600', textTransform: 'capitalize' },
  totalExpense: { fontSize: 15, fontWeight: '600', color: c.accent },
  ...
  expenseInfo: { flex: 1 },
  expenseDesc: { fontSize: 14, fontWeight: '600', color: c.text, marginBottom: 2 },
  expenseMeta: { fontSize: 12, color: c.textTertiary },
  expenseAmount: { fontSize: 15, fontWeight: '600', color: c.text },
  ...
  receiptImageLabel: { fontSize: 12, color: c.textTertiary, fontWeight: '500' },
  ...
  proSectionTitle: { fontSize: 15, fontWeight: '600', color: c.text },
  ...
  proCardInfo: { flex: 1 },
  proCardName: { fontSize: 15, fontWeight: '600', color: c.text },
  ...
  proRatingText: { fontSize: 12, fontWeight: '600', color: c.text },
  ...
  proSelectBtnText: { fontSize: 14, fontWeight: '600', color: c.primary },
  ...
  findProBtnText: { fontSize: 14, fontWeight: '600', color: c.white },
  proPickerWrap: { gap: 8 },
  proPickerLabel: { fontSize: 12, fontWeight: '500', color: c.textTertiary, textTransform: 'uppercase' as const, letterSpacing: 0.5, marginBottom: 4 },
  ...
  proPickerName: { fontSize: 14, fontWeight: '600', color: c.text },
  ...
  collapsibleHeaderTitle: { fontSize: 16, fontWeight: '600', color: c.text },
  collapsibleBadge: { backgroundColor: c.surfaceAlt, paddingHorizontal: 8, paddingVertical: 2, borderRadius: 8, marginLeft: 4 },
  collapsibleBadgeText: { fontSize: 12, fontWeight: '600', color: c.textSecondary },
  ...
  notFoundText: { fontSize: 18, fontWeight: '600', color: c.textSecondary, marginBottom: 16 },
  backBtn: { paddingHorizontal: 20, paddingVertical: 12, borderRadius: 12, backgroundColor: c.primary },
  backBtnText: { fontSize: 14, fontWeight: '600', color: c.white },
  ...
  manualRemoveText: { fontSize: 13, fontWeight: '500', color: c.danger },
  ...
  manualActionTitle: { fontSize: 14, fontWeight: '600', color: c.primary, marginBottom: 2 },
  ...
  recItemTitle: { fontSize: 14, fontWeight: '600', color: c.text, flex: 1 },
  recPriorityBadge: { paddingHorizontal: 7, paddingVertical: 2, borderRadius: 6 },
  recPriorityText: { fontSize: 9, fontWeight: '600', textTransform: 'uppercase' as const },
  ...
  recMetaText: { fontSize: 11, color: c.textTertiary, fontWeight: '500' },
  ...
  appStoreResultName: { fontSize: 15, fontWeight: '600', color: c.text, marginBottom: 2 },
