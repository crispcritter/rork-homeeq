...
const createStyles = (c: ColorScheme) => StyleSheet.create({
  ...
  addProRadiusChipActive: {
    backgroundColor: c.primaryLight,
    borderColor: c.primary,
  },
  addProRadiusChipText: {
    fontSize: 12,
    fontWeight: '600' as const,
    color: c.textSecondary,
  },
  addProRadiusChipTextActive: {
    color: c.primary,
  },
  addProApplianceRow: {
    flexDirection: 'row',
  ...
  addProCheckboxActive: {
    backgroundColor: c.primary,
    borderColor: c.primary,
  },
  addProEmptyAppliances: {
    paddingVertical: Spacing.xl,
    alignItems: 'center',
  },
  addProEmptyAppliancesText: {
    fontSize: 13,
    color: c.textTertiary,
  },
  addProSaveBtn: {
