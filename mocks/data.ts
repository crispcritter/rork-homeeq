import { Appliance, MaintenanceTask, BudgetItem, ServiceProvider } from '@/types';
...
export const sampleBudgetItems: BudgetItem[] = [
  { id: '1', category: 'maintenance', description: 'AC Filter', amount: 25, date: '2026-01-15', applianceId: '1' },
  { id: '2', category: 'repair', description: 'Dishwasher Seal Replacement', amount: 85, date: '2026-01-22', applianceId: '2' },
  { id: '3', category: 'inspection', description: 'Annual HVAC Inspection', amount: 175, date: '2026-02-01', applianceId: '1' },
  { id: '4', category: 'maintenance', description: 'Gutter Guard Install', amount: 320, date: '2026-02-10' },
  { id: '5', category: 'emergency', description: 'Pipe Burst Repair', amount: 450, date: '2026-02-14' },
];
